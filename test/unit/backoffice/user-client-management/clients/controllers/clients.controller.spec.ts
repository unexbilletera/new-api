...
describe('ClientsController', () => {
  ...
  describe('list', () => {
    it('should delegate to service', async () => {
      ...
      service.list.mockResolvedValue(response as any);
    ...
    it('should support search and filter', async () => {
      const query = { search: 'John', status: 'active', page: 1 };
  ...
  describe('getDetails', () => {
    it('should delegate to service', async () => {
      ...
      service.getDetails.mockResolvedValue(response as any);
  ...
  describe('getAccounts', () => {
    it('should delegate to service', async () => {
      ...
      service.getAccounts.mockResolvedValue(response as any);
  ...
  describe('block and unblock operations', () => {
    it('block should delegate to service', async () => {
      const dto = { reason: 'Suspicious activity' };
    ...
    it('block should return success response', async () => {
      const dto = { reason: 'Fraud detected' };
      const response = { success: true, message: 'Client blocked' };
      service.block.mockResolvedValue(response);
  ...
  describe('disable and enable operations', () => {
    it('disable should delegate to service', async () => {
      const dto = { reason: 'Account requested closure' };
