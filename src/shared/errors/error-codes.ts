export enum ErrorCodes {
  ...
  TRANSACTIONS_MAX_AMOUNT_PER_MONTH_EXCEEDED = '400 transactions.errors.maxAmountPerMonthExceeded',
  TRANSACTIONS_INVALID_PIX_KEY = '400 transactions.errors.invalidPixKey',
  ...
  TRANSACTIONS_INVALID_BILLET_BARCODE = '400 transactions.errors.invalidBilletBarcode',
  TRANSACTIONS_INVALID_BILLET_DUE_DATE = '400 transactions.errors.invalidBilletDueDate',
  TRANSACTIONS_BILLET_EXPIRED = '400 transactions.errors.billetExpired',
  TRANSACTIONS_BILLET_ALREADY_PAID = '400 transactions.errors.billetAlreadyPaid',
  TRANSACTIONS_BILLET_NOT_FOUND = '400 transactions.errors.billetNotFound',
  TRANSACTIONS_CRONOS_ERROR = '400 transactions.errors.cronosError',
  TRANSACTIONS_WEBHOOK_INVALID_SIGNATURE = '401 transactions.errors.webhookInvalidSignature',
