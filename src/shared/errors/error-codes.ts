...
export enum ErrorCodes {
  ...
  TRANSACTIONS_INSUFFICIENT_BALANCE = '400 transactions.errors.insufficientBalance',
  TRANSACTIONS_INVALID_AMOUNT = '400 transactions.errors.invalidAmount',
  TRANSACTIONS_MAX_AMOUNT_PER_TRANSACTION_EXCEEDED = '400 transactions.errors.maxAmountPerTransactionExceeded',
  TRANSACTIONS_MAX_AMOUNT_PER_DAY_EXCEEDED = '400 transactions.errors.maxAmountPerDayExceeded',
  TRANSACTIONS_DUPLICATE_TRANSACTION = '400 transactions.errors.duplicateTransaction',
  TRANSACTIONS_MAX_COUNT_PER_DAY_EXCEEDED = '400 transactions.errors.maxCountPerDayExceeded',
  TRANSACTIONS_VELOCITY_LIMIT_EXCEEDED = '400 transactions.errors.velocityLimitExceeded',
  TRANSACTIONS_INVALID_PIX_KEY_CPF = '400 transactions.errors.invalidPixKeyCpf',
  TRANSACTIONS_INVALID_PIX_KEY_CNPJ = '400 transactions.errors.invalidPixKeyCnpj',
  TRANSACTIONS_INVALID_PIX_KEY_EMAIL = '400 transactions.errors.invalidPixKeyEmail',
